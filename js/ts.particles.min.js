    ...
    4: function(t, i, e) {
        ...
        class x {
            ...
            static rgbToHsl(t) {
                ...
                a.h = i === o ? (e - s) / (o - n) : a.h = e === o ? 2 + (s - i) / (o - n) : 4 + (i - e) / (o - n)),
                a.l *= 100,
                a.s *= 100,
                a.h *= 60,
                a.h < 0 && (a.h += 360),
            ...
            static hue2rgb(t, i, e) {
                ...
                return s < 0 && (s += 1),
                s > 1 && (s -= 1),
                s < 1 / 6 ? t + 6 * (i - t) * s : s < .5 ? i : s < 2 / 3 ? t + (i - t) * (2 / 3 - s) * 6 : t
            }
        ...
        class E {
            ...
            static gradient(t, i, e, s) {
                ...
                return h.addColorStop(0, x.getStyleFromHsl(n, s)),
            ...
            static drawParticle(t, i, e, s, o, n, a, r, l) {
                ...
                l.enable && h && (i.shadowBlur = l.blur,
        ...
        class D {
            ...
            moveParticle(t) {
                ...
                s.move.vibrate && (e.position.x += Math.sin(e.position.x * Math.cos(e.position.y)),
        ...
        class L {
            ...
            updateColor(t) {
                ...
                e.particlesOptions.color.animation.enable && (e.color.h += (e.colorVelocity || 0) * s,
            ...
            fixOutOfCanvasPosition() {
                ...
                e === d.destroy) {
                    ...
                    e.left > o.width - i.offset.x ? (i.position.x = n.left,
                    s || (i.position.y = Math.random() * o.height)) : e.right < -i.offset.x && (i.position.x = n.right,
                    s || (i.position.y = Math.random() * o.height)),
                    e.top > o.height - i.offset.y ? (s || (i.position.x = Math.random() * o.width),
                    i.position.y = n.top) : e.bottom < -i.offset.y && (s || (i.position.x = Math.random() * o.width),
            ...
            updateBounce(t) {
                ...
                for (const [,o] of i.plugins)
                    if (void 0 !== o.particleBounce && (s = o.particleBounce(e, t)),
                    s)
                        break;
                if (!s) {
        ...
        class _ {
            ...
            load(t) {
                void 0 !== t && (void 0 !== t.color && (this.color = V.create(this.color, t.color)),
                void 0 !== t.enable && (this.enable = t.enable),
        ...
        class Q {
            ...
            loadShape(t, i, e, s) {
                ...
                this.options[i] = z.deepExtend(null !== (o = this.options[i]) && void 0 !== o ? o : [], t),
                this.options[e] && !s || (this.options[e] = z.deepExtend(null !== (n = this.options[e]) && void 0 !== n ? n : [], t))) : (this.options[i]instanceof Array && (this.options[i] = {},
                this.options[e] && !s || (this.options[e] = {})),
                this.options[i] = z.deepExtend(null !== (a = this.options[i]) && void 0 !== a ? a : {}, t),
                this.options[e] && !s || (this.options[e] = z.deepExtend(null !== (r = this.options[e]) && void 0 !== r ? r : {}, t))))
            }
        }
        !function(t) {
            t.max = "max",
        ...
        class ot {
            ...
            load(t) {
                void 0 !== t && (this.color = V.create(this.color, t.color),
                void 0 !== t.width && (this.width = t.width),
                void 0 !== t.opacity && (this.opacity = t.opacity))
            }
        }
        ...
        class dt {
            constructor(t, i, e) {
                ...
                void 0 !== (null == e ? void 0 : e.shape)) {
                    ...
                    void 0 !== this.shape) {
                        ...
                        this.fill = null !== (a = null === (o = this.shapeData) || void 0 === o ? void 0 : o.fill) && void 0 !== a ? a : this.fill,
                        this.close = null !== (d = null === (c = this.shapeData) || void 0 === c ? void 0 : c.close) && void 0 !== d ? d : this.close)
                    }
                } else {
                    const t = O.shape.type;
                    this.shape = t instanceof Array ? z.itemFromArray(t) : t;
                    const i = O.shape.options[this.shape];
                    i && (this.shapeData = z.deepExtend({}, i instanceof Array ? z.itemFromArray(i) : i),
                    this.fill = null !== (p = null === (v = this.shapeData) || void 0 === v ? void 0 : v.fill) && void 0 !== p ? p : this.fill,
                    this.close = null !== (y = null === (m = this.shapeData) || void 0 === m ? void 0 : m.close) && void 0 !== y ? y : this.close)
                }
                void 0 !== e && O.load(e),
                ...
                this.particlesOptions.opacity.animation.enable && (this.opacity.status = r.increasing,
                ...
                if (H || (H = M.getShapeDrawer(this.shape),
                    ...
                    if (void 0 !== (null == o ? void 0 : o.svgData) && n.replaceColor && a) {
                        ...
                        r.addEventListener("error", () => {
                            ...
                            z.loadImage(n.src).then(t => {
                                this.image && (o.element = t.element,
                                this.image.loaded = !0)
                            }
                            )
                        }
            ...
            calcPosition(t, i) {
                ...
                return (z.isInArray(n, d.bounce) || z.isInArray(n, d.bounceHorizontal)) && (o.x > t.canvas.size.width - 2 * this.size.value ? o.x -= this.size.value : o.x < 2 * this.size.value && (o.x += this.size.value)),
                (z.isInArray(n, d.bounce) || z.isInArray(n, d.bounceVertical)) && (o.y > t.canvas.size.height - 2 * this.size.value ? o.y -= this.size.value : o.y < 2 * this.size.value && (o.y += this.size.value)),
                o
            }
            calculateVelocity() {
                ...
                i.vertical = t.y,
                e.random && (i.horizontal += z.randomInRange(n.left, n.right) / 2,
                i.vertical += z.randomInRange(n.left, n.right) / 2)) : (i.horizontal = t.x + z.randomInRange(n.left, n.right) / 2,
        ...
        class pt {
            ...
            insert(t) {
                ...
                null !== (n = (null === (i = this.northEast) || void 0 === i ? void 0 : i.insert(t)) || (null === (e = this.northWest) || void 0 === e ? void 0 : e.insert(t)) || (null === (s = this.southEast) || void 0 === s ? void 0 : s.insert(t)) || (null === (o = this.southWest) || void 0 === o ? void 0 : o.insert(t))) && void 0 !== n && n))
            }
            query(t, i) {
                var e, s, o, n;
                const a = null != i ? i : [];
                    ...
                    for (const n of a) {
                        ...
                        if (r <= e.retina.grabModeDistance) {
                            ...
                            if (c > 0) {
                                ...
                                let r;
                                if (e.particles.grabLineColor || (e.particles.grabLineColor = s === w.randomColorValue || (null === (i = s) || void 0 === i ? void 0 : i.value) === w.randomColorValue ? w.randomColorValue : x.colorToRgb(s)),
                                r = e.particles.grabLineColor === w.randomColorValue ? x.getRandomRgbColor() : e.particles.grabLineColor,
                                void 0 === r)
                                    return;
                ...
                t.repulse.clicking) {
                    ...
                    for (const i of n) {
                        const {dx: o, dy: n, distance: a} = z.getDistances(s, i.position)
                          ...
                          , c = -e * l / r;
                        r <= e && (t.repulse.particles.push(i),
        ...
        class bt {
            ...
            reset(t, i) {
                t.bubble.inRange && !i || (delete t.bubble.divId,
            ...
            singleDivHover(t, i) {
                ...
                for (const i of l.filter(t => r.contains(t.getPosition()))) {
                    ...
                    const s = e.options.interactivity.modes.bubble.divs
                      , o = z.divMode(s, t);
                    i.bubble.divId && i.bubble.divId === t || (this.reset(i, !0),
                    i.bubble.divId = t),
            ...
            process(t, i, e, s) {
                ...
                if (n !== l)
                    if (o.bubble.durationEnd)
                        c && (d === f.size && delete t.bubble.radius,
            ...
            hoverBubble() {
                ...
                for (const e of s) {
                    ...
                    o <= t.retina.bubbleModeDistance ? n >= 0 && t.interactivity.status === w.mouseMoveEvent && (this.hoverBubbleSize(e, n),
                    this.hoverBubbleOpacity(e, n),
                    this.hoverBubbleColor(e)) : this.reset(e),
            ...
            absorb(t, i) {
                ...
                if (void 0 === t.size.value && void 0 !== i.size.value)
                    ...
                    if (t.size.value >= i.size.value) {
                        ...
                        t.size.value += o,
                        i.size.value -= o,
                        i.size.value <= e.retina.pixelRatio && (i.size.value = 0,
                        i.destroy())
                    } else {
                        const o = z.clamp(i.size.value / t.size.value, 0, t.size.value) * s;
                        t.size.value -= o,
                        i.size.value += o,
                        t.size.value <= e.retina.pixelRatio && (t.size.value = 0,
                        t.destroy())
                    }
            }
        }
        ...
        class Lt {
            ...
            load(t) {
                ...
                void 0 !== t.opacity && (this.opacity = t.opacity),
                void 0 !== t.color && (t.color instanceof Array ? this.color = t.color.map(t => V.create(void 0, t)) : (this.color instanceof Array && (this.color = new V),
                this.color = V.create(this.color, t.color))),
        ...
        class Ht extends Lt {
            load(t) {
                ...
                ) : ((this.divs instanceof Array || !this.divs) && (this.divs = new Vt),
        ...
        class jt extends Ut {
            load(t) {
                ...
                ) : ((this.divs instanceof Array || !this.divs) && (this.divs = new Gt),
                this.divs.load(t.divs)))
            }
        }
        class $t {
        ...
        class ei {
            ...
            manageListeners(t) {
                ...
                o && (e.interactivity.events.onHover.enable || e.interactivity.events.onClick.enable) && (ei.manageListener(o, w.mouseMoveEvent, this.mouseMoveHandler, t),
                ...
                e.interactivity.events.onClick.enable || ei.manageListener(o, w.touchEndEvent, this.touchEndHandler, t),
                ei.manageListener(o, w.mouseLeaveEvent, this.mouseLeaveHandler, t),
                ei.manageListener(o, w.touchCancelEvent, this.touchCancelHandler, t)),
                e.interactivity.events.onClick.enable && o && (ei.manageListener(o, w.touchEndEvent, this.touchEndClickHandler, t),
            ...
            mouseTouchClick(t) {
                ...
                if (void 0 !== o && e.interactivity.events.onClick.enable) {
                    for (const [,t] of i.plugins)
                        if (void 0 !== t.clickPositionValid && (s = t.clickPositionValid(o),
                        s))
                            break;
        ...
        class ni {
            ...
            static set(t, i, e) {
                return s(this, void 0, void 0, (function*() {
                    ...
                    const r = new si(t,e);
                    return o >= 0 ? s.splice(o, 0, r) : s.push(r),
        ...
        class ai {
            ...
            attract(t) {
                ...
                if (o < this.size + t.size.value) {
                    ...
                    this.size > t.size.value && o < this.size - t.size.value ? t.destroy() : (t.size.value -= i,
        ...
        class di {
            ...
            init(t) {
                ...
                ) : (this.interactivityAbsorbers instanceof Array && (this.interactivityAbsorbers = new ci),
        ...
        const ui = new class {
            ...
            needsPlugin(t) {
                ...
                const o = t.absorbers;
                let n = !1;
                return o instanceof Array ? o.length && (n = !0) : (void 0 !== o || (null === (s = null === (e = null === (i = t.interactivity) || void 0 === i ? void 0 : i.events) || void 0 === e ? void 0 : e.onClick) || void 0 === s ? void 0 : s.mode) && z.isInArray(hi.absorber, t.interactivity.events.onClick.mode)) && (n = !0),
                n
            }
            loadOptions(t, i) {
                var e, s;
                ...
                ) : ((o.absorbers instanceof Array || void 0 === o.absorbers) && (o.absorbers = new ci),
                ...
                ) : ((o.interactivity.modes.absorbers instanceof Array || void 0 === o.interactivity.modes.absorbers) && (o.interactivity.modes.absorbers = new ci),
        ...
        class bi {
            ...
            load(t) {
                void 0 !== t && (void 0 !== t.size && (void 0 === this.size && (this.size = new mi),
                this.size.load(t.size)),
                void 0 !== t.direction && (this.direction = t.direction),
        ...
        class wi {
            ...
            init(t) {
                ...
                ) : (this.interactivityEmitters instanceof Array && (this.interactivityEmitters = new bi),
        ...
        const xi = new class {
            ...
            needsPlugin(t) {
                ...
                const o = t.emitters;
                let n = !1;
                return o instanceof Array ? o.length && (n = !0) : (void 0 !== o || (null === (s = null === (e = null === (i = t.interactivity) || void 0 === i ? void 0 : i.events) || void 0 === e ? void 0 : e.onClick) || void 0 === s ? void 0 : s.mode) && z.isInArray(pi.emitter, t.interactivity.events.onClick.mode)) && (n = !0),
                n
            }
            loadOptions(t, i) {
                var e, s;
                ...
                ) : ((o.emitters instanceof Array || void 0 === o.emitters) && (o.emitters = new bi),
                ...
                ) : ((o.interactivity.modes.emitters instanceof Array || void 0 === o.interactivity.modes.emitters) && (o.interactivity.modes.emitters = new bi),
        ...
        class Mi {
            ...
            load(t) {
                var i;
                void 0 !== t && (this.color = V.create(this.color, t.color),
                "string" == typeof this.color.value && (this.opacity = null !== (i = x.stringToAlpha(this.color.value)) && void 0 !== i ? i : this.opacity),
                void 0 !== t.opacity && (this.opacity = t.opacity),
                void 0 !== t.width && (this.width = t.width))
            }
        }
        ...
        class Ti {
            ...
            load(t) {
                ...
                if (void 0 !== t) {
                    ...
                    void 0 !== t.data && ("string" == typeof t.data ? this.data = t.data : (this.data = new Oi,
        ...
        class Ri {
            ...
            static drawPolygonMaskPath(t, i, e, s) {
                ...
                o && (t.strokeStyle = x.getStyleFromRgb(o, e.opacity),
                t.lineWidth = e.width,
                t.stroke(i))
            }
            ...
            resize() {
                const t = this.container
                  , i = this.options;
                i.enable && i.type !== zi.none && (this.redrawTimeout && clearTimeout(this.redrawTimeout),
                this.redrawTimeout = window.setTimeout( () => s(this, void 0, void 0, (function*() {
            ...
            particlesInitialization() {
                ...
                return !(!t.enable || t.type !== zi.inline || t.inline.arrangement !== ki.onePerPoint && t.inline.arrangement !== ki.perPoint) && (this.drawPoints(),
                !0)
            }
            particlePosition(t, i) {
                ...
                return o.type === zi.inline && i && (i.initialPosition = n),
                n
            }
            particleBounce(t) {
                const i = this.options;
