...
(self.webpackChunkzyber = self.webpackChunkzyber || []).push([[941], {
    5213: (e, t) => {
        "use strict";
    ...
    2890: (e, t) => {
        ...
        class _default extends zyberModules.ViewModule {
            getDefaultSettings() {
                return {
                    selectors: {
                        elements: ".zyber-element",
                        nestedDocumentElements: ".zyber .zyber-element"
                    },
                    classes: {
                        editMode: "zyber-edit-mode"
                    }
                }
            }
            getDefaultElements() {
            ...
            getDocumentSettings(e) {
                ...
                if (this.isEdit) {
                    t = {};
                    const e = zyber.settings.page.model;
                    jQuery.each(e.getActiveControls(), (n => {
                        t[n] = e.attributes[n]
                    }
                    ))
                } else
                    t = this.$element.data("zyber-settings") || {};
                return this.getItems(t, e)
            }
            runElementsHandlers() {
                this.elements.$elements.each(( (e, t) => setTimeout(( () => zyberFrontend.elementsHandler.runReadyTrigger(t)))))
            }
            onInit() {
                this.$element = this.getSettings("$element"),
                super.onInit(),
                this.isEdit = this.$element.hasClass(this.getSettings("classes.editMode")),
                this.isEdit ? zyber.on("document:loaded", ( () => {
                    zyber.settings.page.model.on("change", this.onSettingsChange.bind(this))
                }
        ...
        class CarouselHandlerBase extends r.default {
            getDefaultSettings() {
                return {
                    selectors: {
                        ...
                        swiperArrow: ".zyber-swiper-button",
            ...
            getSwiperSettings() {
                const e = this.getElementSettings()
                  ...
                  , n = 1 === t
                  , i = zyberFrontend.config.responsive.activeBreakpoints
                  , r = {
                    mobile: 1,
                    tablet: n ? 1 : 2
                }
                ...
                return a && (s.navigation = {
                    prevEl: ".zyber-swiper-button-prev",
                    nextEl: ".zyber-swiper-button-next"
                }),
                l && (s.pagination = {
                    el: `.zyber-element-${this.getID()} .swiper-pagination`,
                    type: e.pagination ? e.pagination : "bullets",
                    clickable: !0,
                    renderBullet: (e, t) => `<span class="${t}" role="button" tabindex="0" data-bullet-index="${e}" aria-label="${zyberFrontend.config.i18n.a11yCarouselPaginationBulletMessage} ${e + 1}"></span>`
                }),
                ...
                s.a11y = {
                    enabled: !0,
                    prevSlideMessage: zyberFrontend.config.i18n.a11yCarouselPrevSlideMessage,
                    nextSlideMessage: zyberFrontend.config.i18n.a11yCarouselNextSlideMessage,
                    firstSlideMessage: zyberFrontend.config.i18n.a11yCarouselFirstSlideMessage,
                    lastSlideMessage: zyberFrontend.config.i18n.a11yCarouselLastSlideMessage
                },
                s.on = {
                    slideChange: () => {
            ...
            getOffsetWidth() {
                const e = zyberFrontend.getCurrentDeviceMode();
                return zyberFrontend.utils.controls.getResponsiveControlValue(this.getElementSettings(), "offset_width", "size", e) || 0
            }
            applyOffsetSettings(e, t, n) {
                const i = e.offset_sides;
                if (!(zyberFrontend.isEditMode() && "NestedCarousel" === this.constructor.name) && i && "none" !== i)
                    switch (i) {
                    case "right":
            ...
            async initSwiper() {
                const e = zyberFrontend.utils.swiper;
            ...
            bindEvents() {
                ...
                zyberFrontend.elements.$window.on("resize", this.getSwiperSettings.bind(this))
            }
            unbindEvents() {
                ...
                zyberFrontend.elements.$window.off("resize")
            }
            onDirectionArrowKeydown(e) {
                const t = zyberFrontend.config.is_rtl
            ...
            getSpaceBetween() {
                ...
                const t = zyberFrontend.utils.controls.getResponsiveControlValue(this.getElementSettings(), "image_spacing_custom", "size", e);
                return Number(t) || 0
            }
            updateSpaceBetween(e) {
                ...
                "desktop" !== n && (this.swiper.params.breakpoints[zyberFrontend.config.responsive.activeBreakpoints[n].value].spaceBetween = i),
    ...
    7224: (e, t, n) => {
        ...
        e.exports = zyberModules.ViewModule.extend({
            ...
            __construct(e) {
                ...
                this.isEdit = this.$element.hasClass("zyber-element-edit-mode"),
                this.isEdit && this.addEditorListeners())
            },
            isActive: () => !0,
            isElementInTheCurrentDocument() {
                return !!zyberFrontend.isEditMode() && zyber.documents.currentDocument.id.toString() === this.$element[0].closest(".zyber").dataset.zyberId
            },
            findElement(e) {
                var t = this.$element;
                return t.find(e).filter((function() {
                    return jQuery(this).parent().closest(".zyber-element").is(t)
                }
                ))
            },
            ...
            addEditorListeners() {
                ...
                this.getEditorListeners().forEach((function(t) {
                    zyberFrontend.addListenerOnce(e, t.event, t.callback, t.to)
                }
                ))
            },
            removeEditorListeners() {
                var e = this.getUniqueHandlerID();
                this.getEditorListeners().forEach((function(t) {
                    zyberFrontend.removeListeners(e, t.event, null, t.to)
                }
                ))
            },
            getElementType() {
            ...
            getElementSettings(e) {
                ...
                if (this.isEdit && n) {
                    const e = zyberFrontend.config.elements.data[n]
                      , i = e.attributes;
                    let r = i.widgetType || i.elType;
                    i.isInner && (r = "inner-" + r);
                    let s = zyberFrontend.config.elements.keys[r];
                    s || (s = zyberFrontend.config.elements.keys[r] = [],
            ...
            getEditSettings(e) {
                var t = {};
                return this.isEdit && (t = zyberFrontend.config.elements.editSettings[this.getModelCID()].attributes),
                this.getItems(t, e)
            },
            getCurrentDeviceSetting(e) {
                return zyberFrontend.getCurrentDeviceSetting(this.getElementSettings(), e)
            },
            onInit() {
                this.isActive(this.getSettings()) && zyberModules.ViewModule.prototype.onInit.apply(this, arguments)
            },
            onDestroy() {
    ...
    8140: (e, t, n) => {
        ...
        class StretchedElement extends r.default {
            ...
            bindEvents() {
                ...
                zyberFrontend.addListenerOnce(e, "resize", this.stretch),
                zyberFrontend.addListenerOnce(e, "sticky:stick", this.stretch, this.$element),
                zyberFrontend.addListenerOnce(e, "sticky:unstick", this.stretch, this.$element),
                zyberFrontend.isEditMode() && (this.onKitChangeStretchContainerChange = this.onKitChangeStretchContainerChange.bind(this),
                zyber.channels.editor.on("kit:change:stretchContainer", this.onKitChangeStretchContainerChange))
            }
            unbindEvents() {
                zyberFrontend.removeListeners(this.getUniqueHandlerID(), "resize", this.stretch),
                zyberFrontend.isEditMode() && zyber.channels.editor.off("kit:change:stretchContainer", this.onKitChangeStretchContainerChange)
            }
            isActive(e) {
                return zyberFrontend.isEditMode() || e.$element.hasClass(this.getStretchedClass())
            }
            ...
            getStretchElementConfig() {
                return {
                    ...
                    considerScrollbar: zyberFrontend.isEditMode() && zyberFrontend.config.is_rtl
                }
            }
            initStretch() {
                this.stretch = this.stretch.bind(this),
                this.stretchElement = new zyberModules.frontend.tools.StretchElement(this.getStretchElementConfig())
            }
            getStretchContainer() {
                return zyberFrontend.getKitSettings("stretched_section_container") || window
            }
    ...
    7955: e => {
        ...
        e.exports = zyberModules.ViewModule.extend({
            getDefaultSettings: () => ({
                element: null,
                direction: zyberFrontend.config.is_rtl ? "right" : "left",
                selectors: {
                    container: window
                },
                considerScrollbar: !1,
            ...
            stretch() {
                ...
                s || (zyberFrontend.config.is_rtl && (o = i - (n.outerWidth() + o)),
                o = -o),
                e.margin && (o += e.margin);
                var c = {};
                let u = i;
    ...
    7557: (e, t) => {
        ...
        t.setHorizontalScrollAlignment = function setHorizontalScrollAlignment(e) {
            ...
            !function isHorizontalScroll(e, t) {
                ...
                const i = zyberFrontend.config.is_rtl;
                if ("end" === t)
    ...
    751: (e, t, n) => {
        ...
        class InstanceType {
            ...
            static getInstanceType() {
                zyberModules.ForceMethodImplementation()
            }
            constructor() {
                let e = new.target;
                const t = [];
    ...
    4328: (e, t, n) => {
        ...
        class NestedTabs extends r.default {
            ...
            getWidgetNumber() {
                return this.$element.find("> .zyber-widget-container > .e-n-tabs, > .e-n-tabs").attr("data-widget-number")
            }
            getDefaultSettings() {
            ...
            onShowTabContent(e) {
                zyberFrontend.elements.$window.trigger("zyber-pro/motion-fx/recalc"),
                zyberFrontend.elements.$window.trigger("zyber/nested-tabs/activate", e),
                zyberFrontend.elements.$window.trigger("zyber/bg-video/recalc")
            }
            isActiveTab(e) {
                const t = this.getSettings()
            ...
            bindEvents() {
                ...
                zyberFrontend.elements.$window.on("resize", this.onResizeUpdateHorizontalScrolling.bind(this)),
                zyberFrontend.elements.$window.on("resize", this.setTouchMode.bind(this)),
                zyberFrontend.elements.$window.on("zyber/nested-tabs/activate", this.reInitSwipers),
                zyberFrontend.elements.$window.on("zyber/nested-elements/activate-by-keyboard", this.changeActiveTabByKeyboard.bind(this)),
                zyberFrontend.elements.$window.on("zyber/nested-container/atomic-repeater", this.linkContainer.bind(this))
            }
            unbindEvents() {
                this.elements.$tabTitles.off(),
                this.elements.$headingContainer.off(),
                this.elements.$tabContents.children().off(),
                zyberFrontend.elements.$window.off("resize", this.onResizeUpdateHorizontalScrolling.bind(this)),
                zyberFrontend.elements.$window.off("resize", this.setTouchMode.bind(this)),
                zyberFrontend.elements.$window.off("zyber/nested-tabs/activate", this.reInitSwipers),
                zyberFrontend.elements.$window.off("zyber/nested-elements/activate-by-keyboard", this.changeActiveTabByKeyboard.bind(this)),
                zyberFrontend.elements.$window.off("zyber/nested-container/atomic-repeater", this.linkContainer.bind(this))
            }
            reInitSwipers(e, t) {
            ...
            changeActiveTab(e) {
                if (arguments.length > 1 && void 0 !== arguments[1] && arguments[1] && this.isEdit && this.isElementInTheCurrentDocument())
                    return window.top.$e.run("document/repeater/select", {
                        container: zyber.getContainer(this.$element.attr("data-id")),
                        index: parseInt(e)
                    });
            ...
            forceActiveTabToBeInViewport(e) {
                ...
                zyber.helpers.isInViewport(t[0]) || t[0].scrollIntoView({
                    block: "center"
                })
            }
            getActiveClass() {
            ...
            getTabsDirection() {
                const e = zyberFrontend.getCurrentDeviceMode();
                return zyberFrontend.utils.controls.getResponsiveControlValue(this.getElementSettings(), "tabs_justify_horizontal", "", e)
            }
            getHorizontalScrollSetting() {
                const e = zyberFrontend.getCurrentDeviceMode();
                return zyberFrontend.utils.controls.getResponsiveControlValue(this.getElementSettings(), "horizontal_scroll", "", e)
            }
            isAccordionVersion() {
            ...
            setTouchMode() {
                ...
                if (zyberFrontend.isEditMode() || "resize" === event?.type) {
                    const t = ["mobile", "mobile_extra", "tablet", "tablet_extra"]
                      , n = zyberFrontend.getCurrentDeviceMode();
                    if (-1 !== t.indexOf(n))
            ...
            linkContainer(e) {
                ...
                zyber.$preview[0].contentWindow.dispatchEvent(new CustomEvent("zyber/elements/link-data-bindings"))),
